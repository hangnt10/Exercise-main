...
public class TC1{
    ...
    public static void runTest() throws Exception {
     ...
     Client Client2 = new Client("Client2");
        Method method8 = Client.class.getDeclaredMethod("closeGame", null);
        method8.setAccessible(true);
        method8.invoke(Client2, null);

        Method method9 = Client.class.getDeclaredMethod("login", String.class);
        method9.setAccessible(true);
        method9.invoke(Client1, "");
